...
const BannerImage = () => {
  ...
  return (
    <motion.div
      ...
      className=" w-full flex  mt-10 gap-5"
    >
      ...
      <div className="w-1/2 relative flex flex-col gap-10 items-center">
        <div className="hidden sm:block sm:text-6xl md:text-8xl lg:text-9xl lg:mt-10 text-center text-[#3ba944] font-heading">
          Backyard Farming 2.0
        </div>
        <div className="text-md md:text-xl text-[#296633] text-center font-Montserrat">
        ...
        <SignedIn>
          <StartFarmButton
            className="mt-10 text-lg font-dancing lg:text-2xl bg-[#3ba944] hover:bg-[#246d27] duration-100 rounded-tl-full rounded-br-full text-white text-md text-center self-center px-4 py-2 m-2 lg:px-8"
