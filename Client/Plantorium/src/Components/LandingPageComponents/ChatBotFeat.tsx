...
const ChatBotFeat = () => {
  return (
    <div className="relative w-screen flex flex-col items-center justify-center  bg-[#f7fff7] ">
     {/*line1*/}
     <h1 className= "text-6xl font-bold font-poppins text-black flex items-center gap-6 tracking-widest">Turn Your Questions
      <img 
        src= {question} 
        alt="question gif" 
        className="w-52 h-34 inline-block"
        ></img>
      Into Crops
      </h1>
       {/*line2*/} 
      ...
      <div className= "flex flex-col items-start justify-between mt-16">
        <h1 className = "text-3xl font-poppins text-black tracking-widest mt-6 mb-4 w-auto text-center whitespace-nowrap ">Get immediate accurate answers</h1>
