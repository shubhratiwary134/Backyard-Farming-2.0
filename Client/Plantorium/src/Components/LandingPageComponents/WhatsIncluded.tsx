...
const WhatsIncluded = () => {
  return (
    <div className="w-screen px-20  bg-[#486B4A] fonts-poppins">
      ...
      <div className="flex w-full justify-between my-5">
        <div className="w-80 p-9 flex flex-col border-2 border-gray-300 rounded-lg">
          <div className="text-[#F8E6C8]  text-xl flex justify-between items-center tracking-wide">
            Personalized Guidance
            <CiSearch size={30} />
          </div>
          <div className="text-[#BDBDBD] text-gray-300 mt-2 ">
