  ...
  return (
    <div className="bg-black text-white min-h-screen p-10 font-[Poppins]">
      <div className="text-center">
        <h1 className="text-7xl font-poppins font-bold text-[#ffde59] tracking-widest">
          Reports
        </h1>
      </div>
      <div className="flex flex-col gap-10">
        ...
        <div className="group  relative w-full mt-10 flex flex-col gap-10 items-center">
          <p className="text-[#d2d2d1] text-3xl  ml-4 w-full font-poppins tracking-wider">
            Problems and Challenges by Shreya Soni
          </p>
          <img src={image1} alt="report1 image" className=" w-3/4 mt-2   " />
          <div className="absolute bottom-0 backdrop-blur-xl w-3/4 hidden group-hover:flex  justify-center h-16 items-center">
            <a
              ...
              className=" text-blue-500 ml-4 text-2xl hover:underline "
            >
              Read More
            </a>
          </div>
        ...
        {/*report2*/}
        <div className="w-full mt-10 flex flex-col gap-10  items-center">
          <p className=" text-[#d2d2d1] text-3xl  ml-4 w-full font-poppins tracking-wider">
            Knowledge Gaps in Urban Farming: Understanding Public Interest by
            Shreya Soni
          </p>
          <img src={image2} alt="report2 image" className="w-3/4 mt-2   " />
          <a
            target="_blank"
        ...
        <div className="w-full mt-10 flex flex-col gap-10 items-center">
          <p className="text-[#d2d2d1] text-3xl ml-4 w-full font-poppins tracking-wider">
            Marketplace Feature in Backyard Farming 2.0 by Shubhra Tiwary
          </p>
          <img src={image3} alt="report3 image" className="w-3/4 mt-2  " />
          <a
            target="_blank"
        ...
        <div className="w-full mt-10 flex flex-col gap-10 items-center">
          <p className="text-[#d2d2d1] text-3xl  ml-4 w-full font-poppins tracking-wider">
            ...
            Backyard Farming in Emission Reduction by Shubhra Tiwary
          </p>
          <img src={image4} alt="report4 image" className="w-3/4 mt-2  " />
          <a
            target="_blank"
        ...
        <div className="w-full mt-10 flex flex-col gap-10 items-center">
          <p className="text-[#d2d2d1] text-3xl text-center ml-4 w-full font-poppins tracking-wider">
            Personalized Farming Plans: Enhancing Urban Gardening with Tailored
            Roadmaps by Arin Zingade
          </p>
          <img src={image5} alt="report5 image" className="w-3/4 mt-2  " />
          <a
            target="_blank"
